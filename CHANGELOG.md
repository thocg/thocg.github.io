...
## 0.1.6 — 2026-06-21
- Glossary: add 17 terms (now grouped with common synonyms/abbreviations in the header, e.g. "Penetration Tester (Pentester / Pen Tester)").
- New "O" section: add "Operational Technology Security (OT Security)".
- Add requested terms: "API Security", "Supply Chain Attack (Third-Party Attack)", "Ransomware-as-a-Service (RaaS)", "DevSecOps", "Shadow IT".
- Add related terms: "Business Email Compromise (BEC / CEO Fraud)", "Credential Stuffing", "Endpoint Detection and Response (EDR)", "Extended Detection and Response (XDR)", "Lateral Movement", "Multi-Factor Authentication (MFA)", "Network Detection and Response (NDR)", "Principle of Least Privilege (PoLP / Least Privilege)", "Privilege Escalation (Elevation of Privilege, EoP)", "Vishing (Voice Phishing)", "Zero Trust Network Access (ZTNA)".
- Total terms: 199.
